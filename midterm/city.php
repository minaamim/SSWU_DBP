...
$filtered_id = mysqli_real_escape_string($link, $_POST['city']);
//$query = "select * from city LEFT JOIN country ON city.CountryCode = country.Code where country.Name =  '{$filtered_id}'";
$query = "select * from city RIGHT JOIN country ON city.CountryCode = country.Code where country.Name =  '{$filtered_id}'";
